...
* Become familiar with the AWS First Cloud Journey internship program and its regulations.
* Set up the AWS account and learning environment.
* Explore AWS learning paths and choose **DevSecOps (Development, Security, and Operations)** as the primary career direction.
* Develop a personal learning roadmap for **Cyber Security (Red Team)** to strengthen security knowledge for future cloud projects.

### Tasks to be completed this week:

| Day | Tasks | Start Date | Completion Date | References |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| Mon | - Join the AWS First Cloud Journey internship program<br>- Read the internship regulations and participation guidelines<br>- Understand the 12-week learning roadmap and online/offline learning model | 20/04/2026 | 20/04/2026 | https://hcm-rules.awsfcaj.com/1-regulations/ |
...
* Successfully joined the AWS First Cloud Journey internship program and understood the internship regulations.
* Completed the initial AWS account setup, enabled Multi-Factor Authentication (MFA), and became familiar with the AWS Management Console.
* Completed the first Hands-on laboratories provided by AWS Study Group.
* Selected **DevSecOps** as the primary career path, integrating software development, cloud operations, and security best practices.
* Established a personal learning plan for **Cyber Security (Red Team)** to strengthen offensive security knowledge and apply it to building more secure cloud infrastructures in future projects.
* Built a structured learning and note-taking system to support continuous study throughout the internship.